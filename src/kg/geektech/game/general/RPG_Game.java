...
RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(2500, 50, "Boke");
        ...
        Hacker hacker = new Hacker(250 , 15 , "Somedieyoung");
        Antman antman = new Antman(235 , 20 , "Antmy" ,26);
        Hero[] heroes = {warrior, doc, magic, berserk, assistant , hacker, antman};
